...
export const Education = () => {
        ...
        return (
                <div className="h-fit w-screen bg-gray-800 flex  items-center justify-center">
                        ...
                        <div className="h-fit min-h-[32rem] w-[70rem] my-12 max-w-[90%] flex flex-wrap justify-center items-center content-center flex-row gap-7">
                                <div className="bg-gray-700 h-fit min-h-[11rem] w-[32rem] shadow-[5px_5px_0px_0px_rgba(109,40,217)] text-gray-400 p-4 flex flex-col  ">
